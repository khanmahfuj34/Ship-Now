        ...
        <div className="flex flex-col gap-4 w-full select-none">
            ...
            <div className="flex items-center justify-between w-full">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link
                        href="/shipments/new"
                        className="hidden md:flex items-center gap-2.5 px-4 py-3 bg-dark hover:bg-[#222222] text-white text-xs font-heading font-semibold rounded-xl cursor-pointer transition-all duration-200 active:scale-[0.98]"
                    >
